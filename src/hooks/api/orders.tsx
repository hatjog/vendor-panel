...
export const useOrder = (
  ...
  const { data, ...rest } = useQuery({
    ...
    queryFn: async () => mercurVendorClient.orders.retrieve(id, query),
...
export const useOrderCommission = (
  ...
  const { data, ...rest } = useQuery({
    queryFn: async () => mercurVendorClient.orders.commission(id, query),
...
export const useOrderPreview = (
  ...
  const { data, ...rest } = useQuery({
    queryFn: async () =>
      mercurVendorClient.orders.retrieve<HttpTypes.AdminOrderPreviewResponse>(id, query),
...
export const useOrders = (
  ...
  const { data, ...rest } = useQuery({
    queryFn: () => mercurVendorClient.orders.list(query),
...
export const useOrderChanges = (
  ...
  const { data, ...rest } = useQuery({
    queryFn: async () => mercurVendorClient.orders.changes(id),
...
export const useOrderLineItems = (
  ...
  const { data, ...rest } = useQuery({
    queryFn: async () =>
      mercurVendorClient.orders.retrieve<HttpTypes.AdminOrderLineItemsListResponse>(id, query),
...
export const useCreateOrderFulfillment = (
  ...
  return useMutation({
    mutationFn: (payload: HttpTypes.AdminCreateOrderFulfillment) =>
      mercurVendorClient.orders.fulfillments.create(orderId, payload),
...
export const useCreateOrderShipment = (
  ...
  return useMutation({
    mutationFn: (payload: HttpTypes.AdminCreateOrderShipment) =>
      mercurVendorClient.orders.fulfillments.createShipment(orderId, fulfillmentId, payload),
    onSuccess: (data: any, variables: any, context: any) => {
      queryClient.invalidateQueries({
        queryKey: ordersQueryKeys.all
      });
...
export const useMarkOrderFulfillmentAsDelivered = (
  ...
  return useMutation({
    mutationFn: () =>
      mercurVendorClient.orders.fulfillments.markAsDelivered(orderId, fulfillmentId),
    onSuccess: (data: any, variables: any, context: any) => {
      queryClient.invalidateQueries({
        queryKey: ordersQueryKeys.all
      });
...
export const useCancelOrder = (
  ...
  return useMutation({
    mutationFn: () => mercurVendorClient.orders.cancel(orderId),
    onSuccess: (data: any, variables: any, context: any) => {
      queryClient.invalidateQueries({
...
export const useCompleteOrder = (
  ...
  return useMutation({
    mutationFn: () => mercurVendorClient.orders.complete(orderId),
    onSuccess: (data: any, variables: any, context: any) => {
      queryClient.invalidateQueries({
        queryKey: ordersQueryKeys.detail(orderId)
      });
